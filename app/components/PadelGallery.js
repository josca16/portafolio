        ...
        <div className="relative overflow-hidden py-16">
            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="grid grid-cols-1 gap-8">
                    ...
                    <div className="max-w-md sm:max-w-lg mx-auto w-full space-y-4">
                        <div className="relative group">
                            <div className="relative h-[500px] sm:h-[550px] w-full rounded-3xl overflow-hidden bg-slate-950/80 border-2 border-cyan-500/30 hover:border-cyan-400/60 transition-all duration-700 shadow-2xl group-hover:shadow-cyan-500/30">
                                <Image
                                ...
                                <Image
                                    ...
                                    fill
                                    className="object-contain p-2 relative z-10 transition-all duration-700 group-hover:scale-102"
                    ...
                    <div className="grid lg:grid-cols-2 gap-6 hidden md:grid max-w-5xl mx-auto mt-4">
